...
const Comodidades = () => {
    ...
    const handlePost = async () => {
        ...
        formData.append('post_type', 'Comodidades');
    ...
    return (
        <>
            ...
            <Body2>
                ...
                <Text style={{ position: 'absolute', top: 100, color: Colors.dark }}>Escreva as informações da sua comodidade</Text>
